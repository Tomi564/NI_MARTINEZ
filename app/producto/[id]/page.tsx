...
export default function ProductoPage({ params }: ProductoPageProps) {
  ...
  const wsText = encodeURIComponent(
    `Hola, me interesa el neumático ${producto.titulo} (${producto.medida})`,
  );
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-2">
              ...
              <Link
                href={`https://wa.me/5491100000000?text=${wsText}`}
                target="_blank"
                rel="noreferrer"
                className="inline-flex w-full items-center justify-center gap-2 rounded-[4px] border-[1.5px] border-[var(--color-whatsapp)] px-4 py-3 text-[13px] font-bold text-[var(--color-whatsapp)] transition-colors duration-150 hover:bg-[var(--color-whatsapp)] hover:text-white"
              >
                <WhatsappIcon />
